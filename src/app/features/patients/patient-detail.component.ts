          ...
          <div class="card info-card">
            ...
            <div class="info-grid">
              ...
              <div class="info-row">
                ...
                <span class="value">{{ patient()?.telefon || '-' }}</span>
              </div>
              <div class="info-row">
                <span class="label">Versicherung:</span>
                <span class="value">{{ patient()?.insuranceType || '-' }}</span>
              </div>
              <div class="info-row">
                <span class="label">Status:</span>
                <span class="value" [class.active]="patient()?.isActive" [class.inactive]="!patient()?.isActive">
            ...
            @if (patient()?.street || patient()?.city) {
              ...
              <div class="address">
                @if (patient()?.street) {
                  <div>{{ patient()?.street }} {{ patient()?.houseNumber }}</div>
                }
                ...
                @for (apt of filteredAppointments(); track apt.id) {
                  <div class="appointment-item" [class.cancelled]="apt.status === 'CANCELLED'">
                    ...
                    <div class="apt-details">
                      <a [routerLink]="['/dashboard/therapists', apt.therapistId]" class="therapist-link">
                        {{ apt.therapistName }}
                      </a>
